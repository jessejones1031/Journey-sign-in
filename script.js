...
document.querySelectorAll("#attendance-table th").forEach(header => {
...
function displayCurrentDate() {
    ...
    currentDateElement.innerHTML = `Current Date: ${currentDate}`;
}
...
async function loadAttendance() {
    ...
    for (const teenDoc of querySnapshot.docs) {
        ...
        if (attendanceDoc.exists()) {
            ...
            row.innerHTML = `
                <td data-column="name">${teenData.firstName} ${teenData.lastName}</td>
                <td data-column="time">${formatTime(attendanceDoc.data().timestamp)}</td>
                <td data-column="grade">${displayGrade}</td>
                <td data-column="confirmation">${teenData.confirmationLevel}</td>
